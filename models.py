...
class MainIpaddressrule(models.Model):
    id = models.BigAutoField(primary_key=True)
    ip_address = models.CharField(unique=True, max_length=100)
    ...
    class Meta:
        managed = False
        db_table = 'main_ipaddressrule'


class Records(models.Model):
    id = models.BigAutoField(primary_key=True)
    task_id = models.CharField(unique=True, max_length=32)
    temp_result_file_path = models.CharField(max_length=255, blank=True, null=True)
    start_time = models.DateTimeField()
    end_time = models.DateTimeField(blank=True, null=True)
    exec_time = models.CharField(max_length=64, blank=True, null=True)
...
class TuningModels(models.Model):
    id = models.BigAutoField(primary_key=True)
    tuning_id = models.CharField(unique=True, max_length=32)
    tuning_model = models.CharField(max_length=64)
    start_time = models.DateTimeField()
    end_time = models.DateTimeField(blank=True, null=True)
...
class User(models.Model):
    ...
    is_authorize = models.IntegerField()
    is_change_file_type = models.IntegerField()
